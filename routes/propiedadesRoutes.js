...
router.post('/propiedades/crear', 
    ...
    body('descripcion')
        ...
        .isLength({max: 200}).withMessage('La descripción debe contener maximo 200 caracteres'),
...
router.post('/propiedades/agregar-imagen/:id',
    protegerRuta,
    upload.single('imagen'),//para subir una sola imagen si son mas de una se usa array
    almacenarImagen
)
